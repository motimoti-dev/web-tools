...
$example = [
    [
        'title'=>'テストツール',
        'url'=>'./tools/example/',
        'canonical'=>'https://motisan.info/tools/example/',
        'user'=>'',
...
$tools = [
    [
        ...
        'url'=>'./tools/show-text/',
        'canonical'=>'https://motisan.info/tools/show-text/',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/text-replace/',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/calendar-generator/output.php',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/src-illust/',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/meta-tag-generator/',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/copy-paste/output.php',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/time-manage/output.php',
        'user'=>'',
    ...
    [
        ...
        'canonical'=>'https://motisan.info/tools/svg2img/output.php',
        'user'=>'',
        'description'=>'もち用',
        'img'=>'i/svg2png.png',
        'date'=>'2023/09/22',
