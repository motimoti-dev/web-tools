            ...
            <div class="wrapper center" style="margin-top:15px;padding-bottom:10px;max-width: 1350px;">
                <main>
                    ...
                    <section style="display: grid;max-width: 960px;background: white;padding: 1.3rem;border-radius: 12px;" class="s1">
                        ...
                        <p>現在の場所は:<?//?></p>
                        <p>変更する場合のみ入力</p>
                        <button>家(リビング)</button>
                        <button>家(自分の部屋)</button>
                        <button>快活クラブ</button>
                        <button>外</button>
                        <input type='text' placeholder="細かい場所とか">
                        <input type='submit' value='場所を更新'>
                ...
                <iframe id="SidebarIframe" class="SidebarIframe" src="../../static/sidebar.html?date=2023/11/22" role="presentation" style="display:block"></iframe>
            </div>
        </content>
